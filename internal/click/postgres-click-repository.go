...
func (repo *PostgresClickRepository) Create(click *Model) (*Model, error) {
...
func (repo *PostgresClickRepository) GetStatsByLink(linkId string, startDate *time.Time, endDate *time.Time, tz *string) ([]*CountStatItem, error) {
